...
const ServicesTestimonial = () => {
  ...
  const testimonial = [
    {
      title: ' Discover The Nearest Limousine Rental Service',
      desc: "   Renting a limo is not a bothersome task anymore, as we offer  exotic transportation services all around the USA. Just type in “limo service near me” and click on Falcon Tour Travel the expert limo service provider and we will come for you right away!"
    },
    {
      title: '      Let Us Take Care of All Your Needs',
      desc: "In case you’re bored of riding in your old-fashioned car and want to taste the excitement of driving away in an exotic vehicle – we are the right place to look for your limo rental car! Tell us what car makes you feel the most alive and we will arrange it for you."
    },
    {
      title: 'We Offer Much More Than Just Limos',
      desc: "At Falcon Tour travel, you can find a variety of luxury cars that are not only limos, but also modern Sedans, exotic busses, and lavish party vehicles."
    },
  ]
  return (
    <>
      ...
      <section className='bg-black lg:mt-20 mt-8 py-8'>
        <div className='lg:w-[80%]  mx-auto'>
          <div className='grid lg:grid-cols-3 gap-10 lg:gap-5'>
            {testimonial.map((elm,i) => {
              return (
                <div key={i}>
                  <h1 className='text-dark-blue text-4xl mb-8'>
{elm.title}
                  </h1>
      ...
      <Container>
        ...
        <p className='text-center text-xl mb-7 text-gray-600'>
